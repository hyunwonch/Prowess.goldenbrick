function helperModClassPlotTimeDomain2(dataDirectory,modulationTypes,fs)
%helperModClassPlotTimeDomain2 Time domain plots of frames
%   helperModClassPlotTimeDomain2(DIR,MODTYPES,FS) plots a frame for
